...
4. User documentation: Users need simple instructions for locating these controls and adjusting the map scale. Assess whether the existing guide already explains this; add or amend guidance only where needed.
