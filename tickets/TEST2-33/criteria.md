...
- [ ] After the GIS map has loaded, the user guide provides clear instructions for locating the zoom controls and adjusting the map scale, or the guide is amended to provide those instructions if they are missing.
