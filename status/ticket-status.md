...
Updated: 2026-09-25T14:31:17.288Z

| Ticket | Jira Status | QA Status | Retry | Summary |
| --- | --- | --- | --- | --- |
| TEST2-3 | Blocked | Ready for Testing |  | test 3 confusion |
| TEST2-4 | Blocked | Evidence Reviewed | Retry 3/3 | test 4 |
| TEST2-5 | Blocked | Evidence Reviewed |  | test 5 confusion v2 |
| TEST2-10 | Blocked | Awaiting Evidence Review | Retry 3/3 | 2-10 |
| TEST2-11 | Blocked | Blocked | Retry 4/3 | checker |
| TEST2-12 | Blocked | Ready for Testing | Retry 3/3 | Basic screenshot evidence test |
| TEST2-13 | Blocked | Awaiting Evidence Review | Retry 3/3 | Verify launcher displays available V4 modules |
...
| TEST2-19 | READY FOR TESTING | Evidence Reviewed | Retry 3/3 | Launcher controls evidence smoke test |
| TEST2-20 | READY FOR TESTING | Evidence Reviewed | Retry 1/3 | Launcher URL evidence verification |
| TEST2-21 | READY FOR TESTING | Blocked | Retry 3/3 | real ticket |
...
| TEST2-27 | READY FOR TESTING | Evidence Reviewed | Retry 2/3 | Verify returning to the V4 launcher from an opened module |
...
| TEST2-33 | READY FOR TESTING | Evidence Reviewed | Retry 1/3 | Use the GIS map zoom controls |
...
| TEST2-8 | Rejected | Awaiting Evidence Review | Retry 2/3 | Preserve map context when switching GIS panels |
| TEST2-9 | Rejected | Awaiting Evidence Review | Retry 3/3 | Retain selected coverage after returning to the map |
